...
namespace Drupal\update_affiliate_quarterly_submissions\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "Affiliate Quarterly Finance and Governance Submissions",
 *   label = @Translation("Update Affiliate Quarterly Finance and Governance Submissions"),
 *   category = @Translation("Entity Creation"),
 *   description = @Translation("Update Affiliate Quarterly Finance and Governance Submissions"),
...
class UpdateAffiliateQuarterlySubmissions extends WebformHandlerBase {
  ...
  public function postSave(WebformSubmissionInterface $webform_submission, $update = TRUE) {
    ...
    $term->get(field_affiliate_quarterly_financ)->appendItem([
      'uri' => $submission_url,
